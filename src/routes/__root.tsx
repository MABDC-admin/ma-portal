...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient; auth: ReturnType<typeof useAuth> }>()({
  head: () => ({
    meta: [
      ...
      { title: "AttendCloud — Attendance & Daily Lesson Logs" },
      { name: "description", content: "AttendCloud helps schools track live attendance, review Daily Lesson Logs, and manage faculty from one dashboard." },
      { name: "author", content: "AttendCloud" },
      { property: "og:title", content: "AttendCloud — Attendance & Daily Lesson Logs" },
      { property: "og:description", content: "Live attendance, DLL review, and faculty management for modern schools." },
